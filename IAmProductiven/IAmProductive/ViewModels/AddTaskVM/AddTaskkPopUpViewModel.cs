...
{
   public class AddTaskkPopUpViewModel : BaseViewModel
    {
       
        private INavigation navigation;
        private Taskk task; // new task going to be added
        public AddTaskkPopUpViewModel(INavigation nav)
        {
            navigation = nav;
            task = new Taskk();
        }
        ...
        public Taskk Task { get { return task; } set { this.task = value; OnPropertyChanged("Task"); } } // current task to be inserted or updating
