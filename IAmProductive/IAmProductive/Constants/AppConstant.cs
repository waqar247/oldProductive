...
namespace IAmProductive.Constants
{
    public static class  AppConstant
    {
        ...
        // public static string CancelDayAlertBodyText = "Are you sure to delete it ?All tasks of this day will be deleted.";
        ...
        // public static string AlertBodyTextForDeletedDay = "Day";
       ...
       // public static string UnProductiveChartTitle = "UnProductive";
        ...
        //TaskType Colors
        public static string ProductiveTaskColor = "#6be027";
